import type { IdirIdentityProvider, SSOUser } from "@bcgov/citz-imb-sso-js-core";
...
export const AuthProvider = ({ children }) => {
	...
	const [user, setUser] = useState<SSOUser<IdirIdentityProvider> | undefined>(undefined);
	...
	const refresh = useCallback(async () => {
		try {
			...
			notify.error(`Token refresh failed: ${error}`);
			return null;
		}
	}, []);
	...
	return (
		<AuthContext.Provider value={{ accessToken, idToken, hasRole, login, logout, user, refresh }}>
			{children}
