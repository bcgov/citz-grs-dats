...
// TYPES
import { EHttpMethod } from "../types/Enums/EHttpMethod";
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import { IParams } from "../types/Interfaces/IParams";
class HttpService {
  private http: AxiosInstance;
  private baseURL = "http://localhost:5000/api/"; //process.env.NEXT_PUBLIC_BASE_URL;
