...
export const FileListInstructionsPage = () => {
	...
	return (
		<Stack gap={3}>
			...
			<Stack gap={2}>
				<Typography>
					Create a file list for government information stored on a LAN drive.
					Simply add folder and DATS will create a simple list of every
					sub-folder, document, and key metadata properties for you.
				</Typography>
				<Typography>
					Note that a file list created by DATS is required to transfer records
					from a LAN drive to the Digital Archives. But you can also use DATS to
					create lists to help with analysis for clean-ups, destructions, and
					more!
				</Typography>
			</Stack>
			<Stack gap={2}>
				...
				<Typography>
					...
					Digital Archives, please only list Full Retention (FR) records that
