    ...
    return (
      ...
      >
        <Typography sx={{ mt: 1 }} variant="subtitle1">
          You can provide an accession and application number to improve the
          transfer process.
        </Typography>
      ...
      <Box sx={{ gap: 10, padding: 2 }}>
        <Box>
          ...
          <Typography sx={{ mt: 3 }} variant="h3">
            Your request is being processed. You will receive an email with the
            generated file list shortly.
          </Typography>
        </Box>
