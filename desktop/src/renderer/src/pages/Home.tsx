      ...
      <Box>
        ...
        <Stack gap={3} sx={{ margin: 2 }}>
          ...
          <Stack gap={1}>
            ...
            <Typography variant="h4" sx={{ marginLeft: 2 }}>
              For LAN Transfers, use DATS to generate a Digital File List (ARS
              662), a detailed inventory of your records.
            </Typography>
          </Stack>
          ...
          <Stack gap={1}>
            ...
            <Typography variant="h4" sx={{ marginLeft: 2 }}>
              Submit your Transfer Form and File List to GIM staff for a Quality
              Assurance Review.
            </Typography>
          </Stack>
          ...
          <Stack gap={1}>
            ...
            <Typography variant="h4" sx={{ marginLeft: 2 }}>
              Once approved, utilize DATS to securely transfer your digital FR
      ...
      <Stack gap={1}>
        ...
        {authenticated ? (
          <Stack gap={1} sx={{ marginLeft: 2 }}>
            ...
            <Typography variant="h4" sx={{ marginLeft: 2 }}>
              • <b>Create File List</b>: Generate your Digital File List (ARS
              662).
            </Typography>
            <Typography variant="h4" sx={{ marginLeft: 2 }}>
              • <b>Send Records</b>: Transfer your approved FR records to the
              Digital Archives.
            </Typography>
          </Stack>
        ) : (
          <Typography variant="h4" sx={{ marginLeft: 2 }}>
            Please sign in to begin using DATS. Use the <b>Login</b> button at
